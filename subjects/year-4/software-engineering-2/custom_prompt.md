...
## 📚 استراتيجية الأمثلة (Examples Strategy) — MANDATORY

**الفكرة الأساسية:** 
- **بعد كل مفهوم:** أضف مثال عملي فوراً (مو بعد موضوع كامل)
- **مثال تكامل:** بعد 2-3 مواضيع مترابطة، أضف مثال يجمعها كلها
- **الفائدة:** الطالب يرى كيف تُستخدم المفاهيم في الواقع، مو بس نظرية جافة

**ملاحظة من الطلاب:** "الشرح ناشف ما في أمثلة" — هذا يعني كل فقرة بتشرح تحتاج مثال يوضح الفكرة
...
```
**نموذج الشلال:** تخيل بناء بيت — تخطط كل شيء قبل البدء (مخطط، أساس، جدران، كهرباء)، وما تقدر تغير الأساس بعد ما بنيت الجدران. نفس الفكرة: تكمل كل stage (requirement، design، code، test) بالكامل قبل ما تنتقل للـ stage اللي بعده.

**الفرق من Iterative:** في Iterative، بتبني parts صغيرة أولاً وتعديل على الطول — مثل اللي تطبخ وتذوق أثناء الطبخ وتعدّل الملح فوراً.

**متى نستخدمه:** لما المتطلبات واضحة جداً وما بتتغير (مثل نظام بنكي)
```

**القاعدة الذهبية:**
- ✅ **بعد كل فكرة: analogy + مثال عملي + متى نستخدمه**
- ✅ **ترجم المصطلح في أول ظهور:** `الـ SDLC (Software Development Life Cycle - دورة حياة البرمجيات)`
...
- ❌ **ما تترجم بدون شرح** — الترجمة مجرد وسيلة، ما هي الهدف
